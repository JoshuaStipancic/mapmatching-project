...
Algo1 <- unlist(Algo1)
Algo2a[Algo2a == 0] <- NA
Algo2a <- unlist(Algo2a)
Algo2b[Algo2b == 0] <- NA
Algo2b <- unlist(Algo2b)
Algo2c[Algo2c == 0] <- NA
Algo2c <- unlist(Algo2c)
Algo2d[Algo2d == 0] <- NA
Algo2d <- unlist(Algo2d)
Algo3[Algo3 == 0] <- NA
Algo3 <- unlist(Algo3)
Algo4[Algo4 == 0] <- NA
Algo4 <- unlist(Algo4)
...
z <- c("Algo1", "Algo2a", "Algo2b", "Algo2c", "Algo2d", "Algo3","Algo4","Algo5")
...
# -------------
Phone1[Phone1 == 0] <- NA
Phone1 <- unlist(Phone1)
Phone2[Phone2 == 0] <- NA
Phone2 <- unlist(Phone2)
Phone3[Phone3 == 0] <- NA
Phone3 <- unlist(Phone3)
Phone4[Phone4 == 0] <- NA
Phone4 <- unlist(Phone4)
Phone5[Phone5 == 0] <- NA
Phone5 <- unlist(Phone5)
Phone6[Phone6 == 0] <- NA
Phone6 <- unlist(Phone6)
Phone7[Phone7 == 0] <- NA
Phone7 <- unlist(Phone7)
Phone8[Phone8 == 0] <- NA
Phone8 <- unlist(Phone8)
Phone9[Phone9 == 0] <- NA
Phone9 <- unlist(Phone9)
Phone10[Phone10 == 0] <- NA
Phone10 <- unlist(Phone10)

z <- c("Phone1", "Phone2", "Phone3", "Phone4", "Phone5", "Phone6", "Phone7", "Phone8", "Phone9", "Phone10")
dataList <- lapply(z, get, envir=environment())
names(dataList) <- z
boxplot(dataList,
